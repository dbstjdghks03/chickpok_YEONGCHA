...
class PreProcess:
    ...
    def get_sc(self):
        ...
        print(y.shape)
        cent = torchaudio.functional.spectral_centroid(waveform=y, sample_rate=22050, pad=0, window=torch.hann_window(y.shape[0]), n_fft=640, win_length=640, hop_length=256)
